...
package com.example.using.util.apiJson;

import com.example.using.controller.Controller;
import com.example.using.entity.*;
...
//		ACCESS_MAP.put(MyUser.class.getSimpleName(), getAccessMap(MyUser.class.getAnnotation(MethodAccess.class)));
	}
	...
	public String getVisitorIdKey(String table) {
		return Controller.USER_.equals(table) ? Controller.ID : getVisitorIdKey();
	}
